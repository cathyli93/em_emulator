...
class MobilityMngt3(Analyzer):
    ...
    def __on_lte_rrc_msg(self, msg):
        ...
        # print type(log_item['timestamp']), log_item['timestamp']
        ...
        for field in log_xml.iter('field'):
                ...
                for val in field.iter('field'):
                    ...
                    if val.get('name') == 'lte-rrc.utra_FDD':
                        ...
                        self.log_info(str(string2timestamp(
                            log_item['timestamp'])) + " Redirect to " + handoff_state.dump())
            ...
            if field.get('name') == "lte-rrc.measurementReport_element":
                ...
                if meas_id and self.__handoff_sample.cur_state:
                    ...
                    if meas_report[0] and meas_report[1]:
                        # self.log_info(str(string2timestamp(log_item['timestamp'])) +
                        #               ",Measurement report,Current cell," + str(cur_freq) + "," + str(cur_cellid) + "," +
                        #               str(meas_report[1].event_list[0].type) + "," +
            ...
            if field.get('name') == "lte-rrc.measConfig_element":
                ...
                # print ("[rrc]:" + str(string2timestamp(log_item['timestamp'])) + ",Freq," + str(cur_freq))
                meas_state = None
